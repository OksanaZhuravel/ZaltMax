(() => {
    ...
    (() => {
        ...
        function formRating() {
            ...
            function initRatings() {
                ...
                function initRating(rating) {
                    ...
                    if (rating.classList.contains("rating__set")) setRating(rating);
                }
        ...
        if (menuBlocks.length) menuBlocks.forEach((menuBlock => {
            ...
            menuBlock.classList.add(`sub-menu-catalog__block-${menuBlockItems}`);
        }));
        function documentActions(e) {
            ...
            if (targetElement.closest("[data-parent]")) {
                ...
                } else console.log("ой, нет подменю");
                e.preventDefault();
            }
            ...
            if (targetElement.closest(".menu-catalog__back")) {
                ...
                document.querySelector("._sub-menu-active") ? document.querySelector("._sub-menu-open").classList.remove("_sub-menu-open") : null;
                e.preventDefault();
            }
